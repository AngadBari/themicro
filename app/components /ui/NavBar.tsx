...
export default function NavBar() {
  ...
  return (
    <header className="h-16 backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/80 relative">
  <div className="mx-auto max-w-6xl px-4 lg:px-0 mt-8 flex items-center justify-between">
    ...
    <div className="flex items-center gap-10">
      ...
      {/* Desktop Nav */}
      <nav
        className={`${outfit1.className} hidden md:flex items-center gap-2 text-[13px]`}
      >
        <Link
          href="/"
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="hidden md:flex items-center gap-3">
        ...
        <a href="https://github.com/AngadBari/themicro">
          <motion.div
            className="bg-neutral-50 dark:bg-neutral-900 dark:border-neutral-500 border shadow-md border-gray-300 p-2 rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-800 flex gap-2 items-center"
            initial="rest"
            whileHover="hover"
          >
      ...
      <button
        ...
        className="md:hidden p-2 rounded-md border dark:border-neutral-700"
      >
  ...
  {/* Mobile Dropdown */}
  {menuOpen && (
    <div className={`${outfit1.className} absolute top-full left-0 w-full bg-white dark:bg-neutral-950 border-t dark:border-neutral-800 shadow-lg md:hidden z-50`}>
